...
class Tree(Generic):
    def __init__(self, pos, surface, groups, name):
        ...
        self.health = 5
        self.alive = True
        stump_path = f'stardew_valley_in_python/graphics/stumps/{"small" if name == "Small" else "large"}.png'
        self.stump_surface = pygame.image.load(stump_path).convert_alpha()
        self.invul_timer = Timer(200)

        # apples
        self.apple_surface = pygame.image.load('stardew_valley_in_python/graphics/fruit/apple.png')
